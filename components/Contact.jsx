      ...
      <div className="max-w-6xl mx-auto w-full items-center justify-center font-mono text-sm py-6 ">
        ...
        <div data-aos="fade-right" className="grid grid-cols-2 gap-4 mt-16 ">
          <div className="bg-background-1">
            <div className="p-8">
              <div className="">
                <p className="mb-5 text-xl text-description">
                  I am always open to discussing product <br />
          ...
          <div className="overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14067.796929164293!2d84.0919920150659!3d28.178459379276706!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3995980202647001%3A0x88b3c3625fbda20e!2sBegnas%20Lake!5e0!3m2!1sen!2snp!4v1695893460754!5m2!1sen!2snp"
              width="570"
              height="450"
              allowFullScreen=""
              loading="lazy"
