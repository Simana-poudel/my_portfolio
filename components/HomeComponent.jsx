          ...
          <div className='flex-col max-w-6xl mx-auto w-full items-center justify-center font-mono text-sm flex'>
            <div data-aos="fade-up" className='mb-4 flex justify-center'>
              <div>
                ...
                height={300}
                />
                <h5  className='text-text_color leading-6 font-medium text-xl'>{t.intro}</h5>
              </div>
            </div>
            <div  data-aos="fade-up" className='flex-col justify-center text-center '>
              <h1 className='text-4xl	font-bold	leading-5	mt-3 mb-4 animated-text'>{t.profession}</h1>
              <p className='mb-8 text-text_color text-lg max-w-[500px]'>{t.bio}</p>
              <div>
                icons
              </div>
